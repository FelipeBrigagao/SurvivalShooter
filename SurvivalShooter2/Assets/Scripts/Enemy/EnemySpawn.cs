...
public class EnemySpawn : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        timeStartToSpawnEnemys = new float[] {Time.time + timeToStartSpawnBunny, Time.time + timeToStartSpawnBear, Time.time + timeToStartSpawnHellephant, Time.time + 
            timeToStartSpawnNightBunny, Time.time + timeToStartSpawnNightBear, Time.time + timeToStartSpawnNightHell};
